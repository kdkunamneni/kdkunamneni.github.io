...
import { Code, Cloud, Brain, Eye, Database, TrendingUp } from "lucide-react";
import "./Skills.css";
      ...
      skills: [
        {
          ...
          level: 95,
          description:
            "pandas, numpy, polars, Scikit-learn, Matplotlib, spaCy, PyTorch, boto3",
        },
      ...
      skills: [
        {
          name: "AWS",
          level: 90,
          description: "Redshift, S3, HealthLake, SageMaker, Athena",
        },
        ...
        { name: "Docker", level: 65, description: "Containerization" },
        {
          name: "Git",
          level: 85,
          description: "GitHub, GitLab version control",
        },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "LLM", level: 70, description: "Large Language Models" },
        {
          ...
          level: 65,
          description: "Distributed ML approach",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Usagi", level: 80, description: "OMOP vocabulary mapping" },
        {
          name: "IMO APIs",
          level: 75,
          description: "Intelligent Medical Objects",
        },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Perseus", level: 70, description: "Proteomics analysis" },
        {
          name: "Web Scraping",
          level: 85,
          description: "Data extraction techniques",
        },
      ],
    },
  ];
        ...
        >
          ...
          <div className="competencies-grid">
            ...
            <div className="competency-item">
              ...
              <p>
                Predictive modeling, risk stratification, NLP, deep learning
              </p>
            </div>
            <div className="competency-item">
            ...
            <div className="competency-item">
              ...
              <p>
                HEDIS measures, quality metrics, population health analytics
              </p>
            </div>
          </div>
        </motion.div>
